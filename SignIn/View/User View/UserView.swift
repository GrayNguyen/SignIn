            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack{
                    ...
                    HStack(spacing: 10){
                        ...
                        .background(NavigationLink("", destination: SettingView(isEnglish: $isEnglish), isActive: $isShowingSettingView))
                    ...
                    VStack(alignment: .leading){
                        HStack{
                            Text(isEnglish ? "General" : "Thông Tin")
                        ...
                        VStack(alignment: .leading, spacing: 10){
                            ...
                            Text(isEnglish ? "Date of Birth:" : "Ngày, Tháng, Năm Sinh:")
                        ...
                        VStack(alignment: .leading, spacing: 10){
                            Text(isEnglish ? "Gender:" : "Giới Tính")
                        ...
                        VStack(alignment: .leading, spacing: 10){
                            Text(isEnglish ? "Phone:" : "Số Điện Thoại")
                            ...
                            Text(isEnglish ? "Address:" : "Địa Chỉ")
...
struct UserView_Previews: PreviewProvider {
    static var previews: some View {
        UserView(user: .constant(User(firstName: "Long", lastName: "Nguyen",dob: "16/03/2000", gender: "Male", email: "viphilongnguyen@gmail.com", phone: "0834160300", address: "", favourite: [], avatar: "", documentID: "")), userViewModel: .constant(UserViewModel()), isEnglish: .constant(false))
    }
}
