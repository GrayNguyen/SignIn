                ...
                ZStack{
                    ...
                    VStack {
                        HStack{
                            ...
                            ButtonGroup(recipe: $recipe, recipes: $recipes, recipeViewModel: $recipeViewModel, alertMessage: $alertMessage)
                        }
                        .padding(.top, 30)
